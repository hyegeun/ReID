...
from fastreid.evaluation import fusionNet
# from fastreid.evaluation import reid_video
import pandas as pd
import math
...
class ReidEvaluator(DatasetEvaluator):
    def __init__(self, cfg, num_query, query_pid, output_dir=None):
        self.cfg = cfg
    ...
    def process(self, inputs, outputs):
        prediction = {
            ...
            'frames': inputs['frames'].to(self._cpu_device)
        }
    ...
    def evaluate(self):
        ...
        ######################## FusionNet code를 만들어 보자.... ##########################
        fusion_model = self.cfg.FUSIONNET
        parzen = self.cfg.PARZEN
        if fusion_model != "":
            dist = fusionNet.main(dist, query_camids, query_frames, gallery_camids, gallery_frames, fusion_model, parzen)
        ####################################################################################
        ...
        cmc, all_AP, all_INP = evaluate_rank(dist, query_pids, gallery_pids, query_camids, gallery_camids, query_frames, gallery_frames)
